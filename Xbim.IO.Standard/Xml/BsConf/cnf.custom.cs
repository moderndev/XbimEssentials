...
namespace Xbim.IO.Xml.BsConf
{
    public partial class configuration
    {
        public static configuration IFC4Add1
        {
            get
            {
                // var data = Properties.Resources.ResourceManager.GetString("IFC4_ADD1_config");
                var data = Standard.Properties.Resources.IFC4_ADD1_config;
        ...
        public static configuration IFC4
        {
            get
            {
                var data = Standard.Properties.Resources.IFC4_config;
                return Deserialize(data);
            }
        }
        ...
        public static configuration COBieExpress
        {
            get
            {
                var data = Standard.Properties.Resources.COBieExpress_config;
                return Deserialize(data);
            }
        }
