	...
	public partial class IfcElectricDistributionBoard : IExpressValidatable
	{
		...
		public bool ValidateClause(IfcElectricDistributionBoardClause clause) {
			...
			try
			{
				...
				var Log = LogManager.GetLogger(Type.GetType("Xbim.Ifc4.ElectricalDomain.IfcElectricDistributionBoard"));
				Log.Error(string.Format("Exception thrown evaluating where-clause 'IfcElectricDistributionBoard.{0}' for #{1}.", clause,EntityLabel), ex);
			}
			return retVal;
		}
